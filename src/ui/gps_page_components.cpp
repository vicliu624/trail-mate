...
void style_control_button(lv_obj_t* btn, lv_color_t bg)
{
    ...
    lv_obj_set_style_bg_color(btn, lv_color_hex(0xFF6666), LV_STATE_FOCUSED);
    lv_obj_set_style_bg_opa(btn, LV_OPA_40, LV_STATE_FOCUSED);
    ...
    lv_color_t pressed_bg = lv_color_darken(bg, LV_OPA_20);
    lv_obj_set_style_bg_color(btn, pressed_bg, LV_STATE_PRESSED);
