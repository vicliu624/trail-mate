...
// ST7796 initialization command sequence. Orientation is intentionally not
// fixed here because DisplayInterface::init() applies setRotation(0) after
// sending this table.
