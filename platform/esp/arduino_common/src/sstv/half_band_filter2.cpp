...
#include "sstv/half_band_filter2.h"
#include <cstdio>
...
void half_band_filter2 ::filter(int16_t& i, int16_t& q)
{
    ...
    i = (((static_cast<int32_t>(bufi[idx2]) + static_cast<int32_t>(bufi[idx60])) * 1) +
         ...
         static_cast<int32_t>(bufi[idx31]) * 16384) >>
        15;

    q = (((static_cast<int32_t>(bufq[idx2]) + static_cast<int32_t>(bufq[idx60])) * 1) +
         ...
         static_cast<int32_t>(bufq[idx31]) * 16384) >>
        15;
}
