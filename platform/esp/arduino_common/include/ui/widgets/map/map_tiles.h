...
struct MapTile
{
    ...
    uint32_t poi_request_generation = 0;
    uint32_t poi_request_id = 0;
...
// UI-thread housekeeping only: reclaim obsolete results during gestures.
// Does not read storage, decode images or mutate LVGL objects.
