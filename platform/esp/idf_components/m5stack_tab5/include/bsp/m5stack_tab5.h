...
extern "C"
{
    ...
    /**
     * @brief Lock SYS I2C bus for exclusive access
     *
     * This function should be called before any I2C operation on the SYS I2C bus
     * to prevent conflicts with other devices sharing the same bus (ST7123 touch screen,
     * Module GNSS sensors, RTC, built-in IMU, etc.).
     *
    ...
    /**
     * @brief Unlock SYS I2C bus
     *
     * This function should be called after I2C operation is complete to release the bus.
     */
