...
def check_executable_layout_convergence() -> int:
    ...
    failures += check_tokens(
        ...
        [
            ...
            "trailmate_linux_uconsole_gtk_shell",
            "linux_uconsole_gtk_app_shell.cpp",
            "linux_uconsole_gtk_legacy_source_descriptor.cpp",
            "linux_uconsole_gtk_app_shell_smoke.cpp",
            "linux_uconsole_gtk_legacy_source_descriptor_smoke.cpp",
            "add_test",
        ],
    ...
    failures += check_tokens(
        ...
        [
            ...
            "target_id = \"uconsole\"",
            "ux_pack_id = \"uconsole_desktop\"",
            "linux_uconsole_gtk_legacy_source_descriptor.h",
    ...
    failures += check_tokens(
        ...
        [
            ...
            "legacy_source.root_path",
            "legacy_source.replacement_owner",
        ],
    ...
    failures += check_tokens(
        ...
        "uConsole GTK legacy source descriptor",
    )
    ...
    failures += check_tokens(
        ...
        [
            ...
            "trailmate_linux_sim_shell",
            "linux_sim_app_shell.cpp",
            "linux_sim_legacy_source_descriptor.cpp",
            "linux_sim_app_shell_smoke.cpp",
            "linux_sim_legacy_source_descriptor_smoke.cpp",
            "ux_pack_registry",
            "add_test",
        ],
    ...
    failures += check_tokens(
        ...
        [
            ...
            "target_id = \"linux_sim\"",
            "ux_pack_id = \"simulator_full\"",
            "linux_sim_legacy_source_descriptor.h",
    ...
    failures += check_tokens(
        ...
        "Linux sim legacy source descriptor",
    )
