...
namespace boards::tab5::rtc_runtime
{
namespace
{
...
class ScopedRtcDevice
{
  public:
    ScopedRtcDevice()
    {
        ...
        guard_ = std::make_unique<::boards::tab5::Tab5Board::ManagedSystemI2cGuard>(
  ...
  private:
    std::unique_ptr<::boards::tab5::Tab5Board::ManagedSystemI2cGuard> guard_;
