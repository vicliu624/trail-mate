...
{
    static TWatchS3Board singleton;
    return &singleton;
}
...
bool TWatchS3Board::initTouch()
{
    ...
    bool ok = touch_.begin(Wire1, FT6X36_SLAVE_ADDRESS, TOUCH_SDA, TOUCH_SCL);
    if (!ok)
    {
...
BoardBase& board = ::boards::twatchs3::instance;
#endif // defined(ARDUINO_T_WATCH_S3)
