...
#include "../ports/i_team_track_source.h"
...
{
  public:
    TeamTrackSampler(ITeamRuntime& runtime, ITeamTrackSource& track_source)
        : runtime_(runtime), track_source_(track_source)
    {
    }
  ...
  private:
    ...
    ITeamRuntime& runtime_;
    ITeamTrackSource& track_source_;
