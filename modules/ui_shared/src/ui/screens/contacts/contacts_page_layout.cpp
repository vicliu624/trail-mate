...
{
    const auto& profile = ::ui::page_profile::current();
    ::ui::presentation::directory_browser_layout::HeaderSpec header_spec;
    header_spec.height = profile.top_bar_height;
    header_spec.bg_hex = lv_color_to_u32(::ui::theme::surface_alt());
    header_spec.pad_all = 0;
    lv_obj_t* header = ::ui::presentation::directory_browser_layout::create_header_container(root, header_spec);
...
void create_filter_panel(lv_obj_t* parent)
{
    ...
    g_contacts_state.filter_panel = ::ui::presentation::directory_browser_layout::create_selector_panel(parent, panel_spec);
    controls_spec.pad_row = panel_spec.pad_row;
    controls_spec.pad_column = kButtonSpacing;
    lv_obj_t* controls =
        ::ui::presentation::directory_browser_layout::create_selector_controls(g_contacts_state.filter_panel,
                                                                               controls_spec);
    ...
    button_spec.stacked_min_width = std::max<lv_coord_t>(profile.filter_panel_width, 96);

    g_contacts_state.contacts_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.contacts_btn, button_spec);
    ...
    g_contacts_state.nearby_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.nearby_btn, button_spec);
    ...
    g_contacts_state.ignored_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.ignored_btn, button_spec);
    ...
    g_contacts_state.broadcast_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.broadcast_btn, button_spec);
    ...
    g_contacts_state.team_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.team_btn, button_spec);
    ...
    g_contacts_state.discover_btn = lv_btn_create(controls);
    ::ui::presentation::directory_browser_layout::configure_selector_button(g_contacts_state.discover_btn, button_spec);
...
void create_list_panel(lv_obj_t* parent)
{
    ...
    g_contacts_state.list_panel = ::ui::presentation::directory_browser_layout::create_content_panel(parent, panel_spec);
...
void ensure_list_subcontainers()
{
    ...
    if (g_contacts_state.sub_container == nullptr)
    {
        ...
        ::ui::presentation::directory_browser_layout::make_non_scrollable(g_contacts_state.sub_container);
    ...
    if (g_contacts_state.bottom_container == nullptr)
    {
        ...
        ::ui::presentation::directory_browser_layout::make_non_scrollable(g_contacts_state.bottom_container);
                           ...
                           const char* status_text)
{
    ...
    else
    {
        ...
        ::ui::presentation::directory_browser_layout::make_non_scrollable(item);
    }
