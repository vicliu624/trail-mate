...
void create_filter_panel(lv_obj_t* parent)
{
    ...
    g_state.filter_panel = ::ui::presentation::directory_browser_layout::create_selector_panel(parent, panel_spec);
    ...
    g_state.selector_controls =
        ::ui::presentation::directory_browser_layout::create_selector_controls(g_state.filter_panel,
                                                                               controls_spec);
}
...
void create_list_panel(lv_obj_t* parent)
{
    ...
    g_state.list_panel = ::ui::presentation::directory_browser_layout::create_content_panel(parent, panel_spec);
