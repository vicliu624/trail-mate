...
const lv_font_t* font_montserrat_24_safe()
{
...
bool build_base_tile_path(int z, int x, int y, uint8_t map_source, char* out_path, size_t out_size)
{
    ...
    std::snprintf(out_path, out_size, "A:/maps/base/%s/%d/%d/%d.%s", source_dir, z, x, y, ext);
...
NodeInfoWidgets create(lv_obj_t* parent)
{
    ...
    s_widgets.avatar_label = create_label(s_widgets.avatar_bg, "S", font_montserrat_24_safe(), lv_color_hex(0xFFFFFF));
    lv_obj_center(s_widgets.avatar_label);

    s_widgets.name_label = create_label(s_widgets.info_header, "ALFA-3", font_montserrat_22_safe(), kColorText);
    ...
    s_widgets.id_label = create_label(s_widgets.info_footer, "ID: !a1b2c3", font_montserrat_12_safe(), kColorText);
    lv_obj_set_pos(s_widgets.id_label, 6, 4);
    s_widgets.role_label = create_label(s_widgets.info_footer, "Role: -", font_montserrat_12_safe(), kColorText);
    ...
    s_widgets.location_title_label =
        create_label(s_widgets.location_header, "Location", font_montserrat_16_safe(), kColorText);
    ...
    s_widgets.map_label =
        create_label(s_widgets.location_map, "", font_montserrat_12_safe(), kColorTextMuted);
    ...
    s_widgets.link_title_label = create_label(s_widgets.link_header, "Link", font_montserrat_16_safe(), kColorText);
    ...
    s_widgets.link_rssi_label =
        create_label(s_widgets.link_row_1, "RSSI: -112 dBm", font_montserrat_12_safe(), kColorText);
    lv_obj_set_pos(s_widgets.link_rssi_label, 10, -3);
    s_widgets.link_snr_label =
        create_label(s_widgets.link_row_1, "SNR: 7.5 dB", font_montserrat_12_safe(), kColorText);
    lv_obj_set_pos(s_widgets.link_snr_label, 140, -3);
    s_widgets.link_ch_label =
        create_label(s_widgets.link_row_1, "Ch: 478.875", font_montserrat_12_safe(), kColorText);
    lv_obj_set_pos(s_widgets.link_ch_label, 250, -3);
    s_widgets.link_sf_label =
        create_label(s_widgets.link_row_1, "SF: 7", font_montserrat_12_safe(), kColorText);
    lv_obj_set_pos(s_widgets.link_sf_label, 330, -3);
    s_widgets.link_bw_label =
        create_label(s_widgets.link_row_1, "BW: 125k", font_montserrat_12_safe(), kColorText);
    ...
    s_widgets.link_hop_label =
        create_label(s_widgets.link_row_2, "Hop: 2", font_montserrat_12_safe(), kColorTextMuted);
    lv_obj_set_pos(s_widgets.link_hop_label, 10, -3);
    s_widgets.link_last_heard_label =
        create_label(s_widgets.link_row_2, "Last heard: 18s", font_montserrat_12_safe(), kColorTextMuted);
