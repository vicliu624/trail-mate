...
```bash
python tools/build_locale_pack_charset.py --pack-root packs/locale-bundles/europe-latin-ext --font-pack-id latin-ext-eu
```
...
python tools/generate_binfont_with_lv_font_conv.py `
  ...
  --charset-file packs/locale-bundles/europe-latin-ext/fonts/latin-ext-eu/charset.txt `
  --output packs/locale-bundles/europe-latin-ext/fonts/latin-ext-eu/font.bin `
  --size 16 `
  --bpp 2 `
