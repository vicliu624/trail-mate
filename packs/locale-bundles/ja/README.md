...
```bash
python tools/build_locale_pack_charset.py --pack-root packs/locale-bundles/ja --font-pack-id ja-cjk
```
...
python tools/generate_binfont_with_lv_font_conv.py `
  ...
  --charset-file packs/locale-bundles/ja/fonts/ja-cjk/charset.txt `
  --output packs/locale-bundles/ja/fonts/ja-cjk/font.bin `
  --size 16 `
  --bpp 2 `
