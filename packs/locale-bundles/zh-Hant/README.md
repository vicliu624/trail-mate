...
```bash
python tools/build_locale_pack_charset.py --pack-root packs/locale-bundles/zh-Hant --font-pack-id zh-hant-cjk
```
...
python tools/generate_binfont_with_lv_font_conv.py `
  ...
  --charset-file packs/locale-bundles/zh-Hant/fonts/zh-hant-cjk/charset.txt `
  --output packs/locale-bundles/zh-Hant/fonts/zh-hant-cjk/font.bin `
  --size 16 `
  --bpp 2 `
