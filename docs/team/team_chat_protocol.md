...
- 新增端口：
  - `TEAM_CHAT_APP = 303`（在 `modules/core_team/include/team/protocol/team_portnum.h` 中定义）
- 加密方式：
...
1. **协议与端口**
   - `modules/core_team/include/team/protocol/team_portnum.h` 新增 `TEAM_CHAT_APP = 303`
