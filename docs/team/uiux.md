...
│  Pending (2)                                 │
│  ──────────────────────────────────────────  │
│  Tom   (Node 0x12AB...)    [ Accept ] [Reject]│
│  Jerry (Node 0x98CD...)    [ Accept ] [Reject]│
│                                              │
│  Leader handles 1 at a time (v0.1)            │
└──────────────────────────────────────────────┘
```

> v0.1 并发策略：Leader 一次只处理 **1 个 pending join**，其余排队/稍后重试
