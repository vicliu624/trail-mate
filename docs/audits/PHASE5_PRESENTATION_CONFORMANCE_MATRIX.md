...
| Chat | `ChatWorkspaceModel` | `ChatWorkspaceSnapshot` | `LegacyChatPresentationSource` | `LegacyChatActionSink` | chat workspace and legacy adapter tests | `ChatUiController` migrated path | `CHAT_UI_CONTROLLER_LEGACY_OWNERSHIP_AUDIT.md` | ready-with-legacy |
